...
const MarketPricing = (): React.JSX.Element => {
    // const getCurrencyData = useGetLatestPrice()
    // const [rowData, setRowData] = useState<ForexPricePairs[]>([])
    ...
    //         setRowData(getCurrencyData.data?.response)
    //     }
...
//                                     <TableRow
//                                         hover
//                                         onClick={(event) => { handleClick(event, row.s.replace("/", "-")); }}
//                                         tabIndex={-1}
//                                         key={row.s}
//                                         sx={{ cursor: 'pointer' }}
